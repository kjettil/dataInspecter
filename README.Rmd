...
## Data
This package comes with a dataset that shows the tetracyclines consumption in the EU/EEA from 2011 till 2020. ?tetracyclines_usage will give you usethis::use_vignette("my-vignette")more detailed information about the dataset.
